...
T0 = #;                      % temperature (constant) at t = 0 s (°C)
TL = #;                      % temperature (vector = function of time t) at x = 0 m (°C)
...
xplot = [0 0.02 0.04 0.08 0.12 0.16 0.2 0.3];
